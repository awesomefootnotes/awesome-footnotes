		...
		protected static function get_defaults() {
			...
			$defaults = array(
				...
				'message'    => sprintf(
					...
					esc_html__( 'Hey! It&#039;s been a little while that you&#039;ve been using %s. You might not realize it, but user reviews are such a great help to us. We would be so grateful if you could take a minute to leave a review on WordPress.org. Many thanks in advance :)', 'awesome-footnotes' ),
					'<b>Awesome Footnotes</b>'
				),
				'link_label' => esc_html__( 'Click here to leave your review', 'awesome-footnotes' ),
