...
if ( ! class_exists( '\AWEFOOT\Settings\Settings_Builder' ) ) {
	...
	class Settings_Builder {
		...
		private static function upload() {
			...
			$upload_button = ! empty( self::$settings['custom_text'] ) ? self::$settings['custom_text'] : esc_html__( 'Upload', 'awesome-footnotes' );
		...
		private static function gallery() {
			...
			value="<?php esc_html_e( 'Add Image', 'awesome-footnotes' ); ?>">
			...
			jQuery(document).ready(function() {
				...
				jQuery(document).on('click', '#<?php echo esc_attr( self::$item_id ); ?>-upload', function(
					...
					awefoot_slider_uploader = wp.media.frames.awefoot_slider_uploader = wp.media({
						...
						button: {
							text: '<?php esc_html_e( 'Select', 'awesome-footnotes' ); ?>'
						},
						multiple: true,
					});
		...
		private static function background() {
			...
			value="<?php esc_html_e( 'Upload', 'awesome-footnotes' ); ?>">
			...
			<div class="fme-background-options">
				...
				<select name="<?php echo esc_attr( self::$option_name ); ?>[repeat]"
					...
					?>
					><?php esc_html_e( 'no-repeat', 'awesome-footnotes' ); ?></option>
					<option value="repeat" 
					<?php
					if ( ! empty( $current_value['repeat'] ) ) {
						selected( $current_value['repeat'], 'repeat' );}
					?>
					><?php esc_html_e( 'Tile', 'awesome-footnotes' ); ?></option>
					<option value="repeat-x" 
					<?php
					if ( ! empty( $current_value['repeat'] ) ) {
						selected( $current_value['repeat'], 'repeat-x' );}
					?>
					><?php esc_html_e( 'Tile Horizontally', 'awesome-footnotes' ); ?></option>
					<option value="repeat-y" 
					<?php
					if ( ! empty( $current_value['repeat'] ) ) {
						selected( $current_value['repeat'], 'repeat-y' );}
					?>
					><?php esc_html_e( 'Tile Vertically', 'awesome-footnotes' ); ?></option>
				</select>
				...
				<select name="<?php echo esc_attr( self::$option_name ); ?>[attachment]"
					...
					?>
					><?php esc_html_e( 'Fixed', 'awesome-footnotes' ); ?></option>
					<option value="scroll" 
					<?php
					if ( ! empty( $current_value['attachment'] ) ) {
						selected( $current_value['attachment'], 'scroll' );}
					?>
					><?php esc_html_e( 'Scroll', 'awesome-footnotes' ); ?></option>
					<option value="cover" 
					<?php
					if ( ! empty( $current_value['attachment'] ) ) {
						selected( $current_value['attachment'], 'cover' );}
					?>
					><?php esc_html_e( 'Cover', 'awesome-footnotes' ); ?></option>
				</select>
				...
				<select name="<?php echo esc_attr( self::$option_name ); ?>[hor]"
					...
					?>
					><?php esc_html_e( 'Left', 'awesome-footnotes' ); ?></option>
					<option value="right" 
					<?php
					if ( ! empty( $current_value['hor'] ) ) {
						selected( $current_value['hor'], 'right' );}
					?>
					><?php esc_html_e( 'Right', 'awesome-footnotes' ); ?></option>
					<option value="center" 
					<?php
					if ( ! empty( $current_value['hor'] ) ) {
						selected( $current_value['hor'], 'center' );}
					?>
					><?php esc_html_e( 'Center', 'awesome-footnotes' ); ?></option>
				</select>
				...
				<select name="<?php echo esc_attr( self::$option_name ); ?>[ver]"
					...
					?>
					><?php esc_html_e( 'Top', 'awesome-footnotes' ); ?></option>
					<option value="bottom" 
					<?php
					if ( ! empty( $current_value['ver'] ) ) {
						selected( $current_value['ver'], 'bottom' );}
					?>
					><?php esc_html_e( 'Bottom', 'awesome-footnotes' ); ?></option>
					<option value="center" 
					<?php
					if ( ! empty( $current_value['ver'] ) ) {
			...
			<div id="<?php echo esc_attr( self::$item_id ); ?>-preview" class="img-preview" 
				...
				<img src="
					...
					?>
					" alt="">
				<a class="del-img" title="<?php esc_html_e( 'Remove', 'awesome-footnotes' ); ?>"></a>
			</div>
			...
			<div class="fme-custom-select typography-custom-select">
				<select name="<?php echo esc_attr( self::$option_name ); ?>[line_height]"
					...
					<option <?php selected( $current_value['line_height'], '' ); ?> <?php disabled( 1, 1 ); ?>>
						<?php esc_html_e( 'Line Height', 'awesome-footnotes' ); ?></option>
					<option value=""><?php esc_html_e( 'Default', 'awesome-footnotes' ); ?></option>
			...
			<div class="fme-custom-select typography-custom-select">
				<select name="<?php echo esc_attr( self::$option_name ); ?>[weight]"
					...
					<option <?php selected( $current_value['weight'], '' ); ?> <?php disabled( 1, 1 ); ?>>
						<?php esc_html_e( 'Font Weight', 'awesome-footnotes' ); ?></option>
					<option value=""><?php esc_html_e( 'Default', 'awesome-footnotes' ); ?></option>
					<option value="100" <?php selected( $current_value['weight'], 100 ); ?>>
						<?php esc_html_e( 'Thin 100', 'awesome-footnotes' ); ?></option>
					<option value="200" <?php selected( $current_value['weight'], 200 ); ?>>
						<?php esc_html_e( 'Extra 200 Light', 'awesome-footnotes' ); ?></option>
					<option value="300" <?php selected( $current_value['weight'], 300 ); ?>>
						<?php esc_html_e( 'Light 300', 'awesome-footnotes' ); ?></option>
					<option value="400" <?php selected( $current_value['weight'], 400 ); ?>>
						<?php esc_html_e( 'Regular 400', 'awesome-footnotes' ); ?></option>
					<option value="500" <?php selected( $current_value['weight'], 500 ); ?>>
						<?php esc_html_e( 'Medium 500', 'awesome-footnotes' ); ?></option>
					<option value="600" <?php selected( $current_value['weight'], 600 ); ?>>
						<?php esc_html_e( 'Semi 600 Bold', 'awesome-footnotes' ); ?></option>
					<option value="700" <?php selected( $current_value['weight'], 700 ); ?>>
						<?php esc_html_e( 'Bold 700', 'awesome-footnotes' ); ?></option>
					<option value="800" <?php selected( $current_value['weight'], 800 ); ?>>
						<?php esc_html_e( 'Extra 800 Bold', 'awesome-footnotes' ); ?></option>
					<option value="900" <?php selected( $current_value['weight'], 900 ); ?>>
						<?php esc_html_e( 'Black 900', 'awesome-footnotes' ); ?></option>
				</select>
			</div>
